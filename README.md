...
上記のような課題に対して、
“**ユーザーがより快適に使える**”,“**とにかく手軽でシンプル**”というコンセプトをもとに設計することで、学習記録をつけるハードルを下げ、習慣化を促すことで課題を解決できるようにしたいと考え、作成に至りました。
...
### ログアウト
ログイン後に表示されるユーザーアイコンをクリックし、プルダウンから` ログアウト `をクリックすることでログアウトできます。
### メールアドレス変更
ログイン後に表示されるユーザーアイコンをクリックし、プルダウンから` アカウント編集 `をクリックするとメールアドレス変更画面に遷移します。
### ゲスト登録
...
## スキル設定
ユーザー登録をするとスキル設定ページに遷移します。このページでは、これから伸ばしていきたいスキルを設定することができます。
...
棒グラフと円グラフを表示し、月別学習時間とスキル別学習時間を表示させることができるようになっています。
